...
form.addEventListener('submit', function (event) {
    ...
    if (usertype === "بادئ الاجتماع") {
        ...
        url = 'http://127.0.0.1:8000/api/admin/addAdmin'
    ...
    fetch(url, {
        ...
        .then(data => {
            ...
            for (user of data) {
                ...
                console.log(user.adminstration);
                let content = `
                <div id="getusers" class="row box">
                    <div class="col-md-3">
                        <div class="card border-0 h-100">
                            <div class="card-body">
                                <a class="btn btn-transparent" onclick="updateUser(${user.id})" href="edituser.html" 
                                    style="background-color: transparent; border: 0px;"><img
                                        ...
                                        <div class="card-body">
                                        <button id="butt" class="btn btn-primary" onclick="mySpecificFunction(${user.id})" style="text-decoration: underline; height: 15;">حذف</button>
                                        </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 h-100">
                            <div id="datashown" class="card-body">
                                <p id="showname" class="card-text" style="text-align:right;">${user.name}</p>
                                <p id="showdept" class="card-text" style="text-align:right;">نظم المعلومات</p>
                            </div>
                        </div>
                    </div>
                </div>
